    ...
    return html`
      <div class="qr">
        <svg id="qr" viewBox="0 0 370 370">
          ...
          />
          <path style="stroke:none;" d="M280 60L280 90L310 90L310 60L280 60z" />
          <path
            style="fill:currentColor; stroke:none;"
          ...
          />
          <path style="stroke:none;" d="M40 130L40 140L50 140L50 130L40 130z" />
          <path
            style="fill:currentColor; stroke:none;"
      ...
      ${ShareApp._show() === true
        ? html` <button class="half" @click="${ShareApp._share}">Jaa</button> `
        : ''}
    `;
  }
